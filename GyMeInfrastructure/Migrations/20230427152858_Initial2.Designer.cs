...
namespace GymAppInfrastructure.Migrations
{
    ...
    [Migration("20230427152858_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GyMeCore.Models.Entities.FriendRequest", b =>
                {
            ...
            modelBuilder.Entity("GyMeCore.Models.Entities.Premium", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GyMeCore.Models.Entities.FriendRequest", b =>
                {
                    b.HasOne("GyMeCore.Models.Entities.User", "Recipient")
                        .WithMany("RecipientFriendRequests")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GyMeCore.Models.Entities.User", "Sender")
            ...
            modelBuilder.Entity("GyMeCore.Models.Entities.Premium", b =>
                {
                    b.HasOne("GyMeCore.Models.Entities.User", "User")
                        .WithOne("Premium")
                        .HasForeignKey("GyMeCore.Models.Entities.Premium", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
